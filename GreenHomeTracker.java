...
public class GreenHomeTracker {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("1. Set Household Name");
                ...
                switch (choice) {
                    ...
                    case "2":
                        if (householdName.isEmpty()) {
                            ...
                            System.out.println("Energy Tracker added.");
                        }
                        break;
                    ...
                    case "3":
                        if (householdName.isEmpty()) {
                            ...
                            System.out.println("Water Tracker added.");
                        }
                        break;
                    ...
                    case "4":
                        if (householdName.isEmpty()) {
                            ...
                            System.out.println("Waste Tracker added.");
                        }
                        break;
